...
namespace iCAX
{
    namespace Geom
    {
        ...
        */
        class _GEOMETRY_EXP MltBndCurve2 : public BndCurve2
        {
        public:
            /**
            * @brief 构造函数
            ...
            */
            MltBndCurve2(IN const CoordSys2& csLocal_);

            /**
            * @brief 默认析构函数
            */
            virtual ~MltBndCurve2();
        ...
        public:
            ...
            * @return 智能指针段列表
            */
            const std::vector<std::shared_ptr<SglBndCurve2>>& Segments() const;
            ...
            */
            void ResolveU2Segment(IN const double& nU_, IN const bool& bLeft_, OUT std::shared_ptr<SglBndCurve2>& pSeg_, OUT double& nLocalU_) const;
        ...
        public://!< Curve2 接口
            ...
            */
            virtual Point2 Evaluate(IN const double& nU_) const override final;
        ...
        protected:
            std::vector<std::shared_ptr<SglBndCurve2>> m_lstSegments; //!< 段列表（支持任意单段曲线）
