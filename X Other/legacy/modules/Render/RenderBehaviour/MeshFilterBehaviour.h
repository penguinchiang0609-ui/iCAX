...
namespace iCAX
{
    namespace Render
    {
        ...
        * @brief 渲染网格行为
        */
        class _RENDERBEHAVIOUR_EXP CMeshFilterBehaviour : public CBehaviourBase
        {
        public:
            /*
            * @brief 构造函数
            */
            CMeshFilterBehaviour();

            /*
            * @brief 析构函数
            */
            virtual ~CMeshFilterBehaviour();
        ...
        protected:
            ...
            */
            ...
            AUTO_REGIST_BEHAVIOUR(CMeshFilterBehaviour);
        };
    }
}