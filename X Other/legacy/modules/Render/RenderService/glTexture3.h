...
#include <vector>
#include <array>
#include "../RenderComponent/Texture3.h"
...
namespace iCAX
{
    namespace Render
    {
        /**
        * @class glTexture3
        * @brief 三维纹理的 OpenGL 封装
        * @details
        * 用于将 rTexture3 上传到 GPU 并管理 OpenGL 3D 纹理对象。
        */
        class glTexture3
        {
        public:
        ...
        public:
            /**
            * @brief 上传 CPU 层纹理到 GPU
            * @param [in] Tex_ rTexture3 对象
            * @return 是否上传成功
            */
            bool Upload(IN const rTexture3& Tex_);
