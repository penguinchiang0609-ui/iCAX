...
$BuildProjects = @(
    ...
    "src\icax-engine\framework\CommandTargets\CommandTargets.vcxproj",
    "src\tests\icax-engine\framework\CommandTargets\CommandTargetsTest\CommandTargetsTest.vcxproj",
...
$TestExecutables = @(
    ...
    "src\icax-engine\$Platform\$Configuration\CommandTargetsTest.exe",
