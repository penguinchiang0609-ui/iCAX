...
namespace
{
    class CSelectionTarget final : public iCAX::Command::CCommandTarget
    {
    public:
        CSelectionTarget()
            : CCommandTarget("Selection")
        {
            Bind("Get", &iCAX::CAM::Commands::HandleGetSelection);
            Bind("PickTopology", &iCAX::CAM::Commands::HandlePickTopology);
            Bind("PickMachineObject", &iCAX::CAM::Commands::HandlePickMachineObject);
        }
    };

    static_assert(iCAX::Command::IsStatelessCommandTargetType<CSelectionTarget>);
}

ICAX_REGISTER_COMMAND_TARGET(CSelectionTarget)
...
namespace
{
    ...
    iCAX::Command::CCommandResponse MakeSelectionResponse(IN iCAX::Database::IRepository& Repository_)
    {
        ObjectMap _Result;
...
iCAX::Command::CCommandResponse HandleGetSelection(
