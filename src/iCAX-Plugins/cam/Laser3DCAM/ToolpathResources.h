...
namespace iCAX
{
    namespace CAM
    {
        ...
        */
        struct CTopologyResource final
        {
            inline static constexpr const char* kResourceTypeName = "topology";
        ...
        */
        struct CPathCurveResource final
        {
            inline static constexpr const char* kResourceTypeName = "path.curve";
        ...
        *   曲线资源与姿态场资源的对应关系由 Path Entity 上的 CPathComponent 维护。
        ...
        */
        struct CPoseFieldResource final
        {
            inline static constexpr const char* kResourceTypeName = "pose.field";

            uint64_t nVersion = 0;                   //!< 姿态场资源版本。
            std::vector<SPoseSample> Samples;      //!< 姿态采样点数组。
        };
    }
}
