...
namespace
{
class CWorkpieceEditSDO final : public iCAX::Interaction::CSDO
{
public:
...
static_assert(iCAX::Interaction::IsStatelessSDOType<CWorkpieceEditSDO>);
}

ICAX_REGISTER_SDO(CWorkpieceEditSDO)
