...
////!< 提交事务
//void iCAX::Tracker::CTransaction::Commit(IN bool bCancel_)
//{
//    if (m_pRepository.expired())
//    {
//        return;
//    }
//    m_pRepository->AddObserver(shared_from_this());
//
//    if (bCancel_)
//    {
//        m_ActualOperations.clear();
//        m_Operations.clear();//!< 取消所有操作申请
//    }
//    else
//    {
//        m_ActualOperations.clear();
...
//        m_Operations.clear();
//    }
//    m_pRepository->RemoveObserver(shared_from_this());
//}
...
void iCAX::Tracker::CTransaction::OnCommit()
{
    ...
    for (Operation& _Operation : m_Operations)
    {
        ...
        {
            auto _pDomain = m_pRepository.lock()->GetDomain(_Operation.DomainID);
            if (!_pDomain)
            {
                m_bCommitSuccess = false; 
                return;
        ...
        case Operation::kAttachComponent:
        {
            ...
            _pEntity->AddComponent(_Operation.ClassType);
            break;
        }
