...
namespace iCAX
{
    namespace Geom
    {
        ...
        * @brief 二维四阶贝塞尔曲线
        * @details
        * QuarticBezier2 表示定义在局部坐标系内的二维四阶开口贝塞尔曲线。
        *
        * - 曲线由 5 个控制点定义：起点、3 个中间控制点、终点；
        ...
        */
        class _GEOMETRY_EXP QuarticBezier2 final : public SglBndCurve2
        {
        public:
            /**
            * @brief 构造函数
            ...
            * @param [in] pt4_ 终点
            */
            QuarticBezier2(IN const Point2& pt0_, IN const Point2& pt1_, IN const Point2& pt2_, IN const Point2& pt3_, IN const Point2& pt4_);

            /**
            * @brief 默认析构函数
            */
            virtual ~QuarticBezier2();
        ...
        public: //!< 成员访问
            ...
            * @param [in] pt_
            */
            void SetP4(IN const Point2& pt_);
