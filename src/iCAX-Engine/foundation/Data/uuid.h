...
namespace iCAX
{
    namespace Data
    {
        ...
        _DATA_EXP uuid GenerateNewUUID();
        _DATA_EXP uuid GenerateNilUUID();
    }
}
...
{
    template <>
    struct hash<iCAX::Data::uuid>
    {
        using argument_type = iCAX::Data::uuid;
        using result_type = std::size_t;

        [[nodiscard]] result_type operator()(argument_type const& uuid_) const
        {
...
#else
            uint64_t l =
                static_cast<uint64_t>(uuid_.data[0]) << 56 |
                static_cast<uint64_t>(uuid_.data[1]) << 48 |
                static_cast<uint64_t>(uuid_.data[2]) << 40 |
                static_cast<uint64_t>(uuid_.data[3]) << 32 |
                static_cast<uint64_t>(uuid_.data[4]) << 24 |
                static_cast<uint64_t>(uuid_.data[5]) << 16 |
                static_cast<uint64_t>(uuid_.data[6]) << 8 |
                static_cast<uint64_t>(uuid_.data[7]);
            uint64_t h =
                static_cast<uint64_t>(uuid_.data[8]) << 56 |
                static_cast<uint64_t>(uuid_.data[9]) << 48 |
                static_cast<uint64_t>(uuid_.data[10]) << 40 |
                static_cast<uint64_t>(uuid_.data[11]) << 32 |
                static_cast<uint64_t>(uuid_.data[12]) << 24 |
                static_cast<uint64_t>(uuid_.data[13]) << 16 |
                static_cast<uint64_t>(uuid_.data[14]) << 8 |
                static_cast<uint64_t>(uuid_.data[15]);
