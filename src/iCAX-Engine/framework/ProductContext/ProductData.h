...
namespace iCAX
{
    namespace Product
    {
        ...
        * @brief 最近打开项目记录。
        */
        struct _PRODUCT_CONTEXT_EXP CRecentProjectItem final
        {
        ...
        * @brief 产品数据存储接口。
        */
        class _PRODUCT_CONTEXT_EXP IProductDataStore
        {
        public:
        ...
        */
        class _PRODUCT_CONTEXT_EXP CFileProductDataStore final : public IProductDataStore
        {
        public:
            /*
            * @brief 构造文件型产品数据存储。
