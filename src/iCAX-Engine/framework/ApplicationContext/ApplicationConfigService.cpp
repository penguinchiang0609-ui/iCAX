...
iCAX::Application::CApplicationConfigService::CApplicationConfigService(IN std::shared_ptr<CApplicationContext> pContext_, IN std::shared_ptr<IApplicationConfigStore> pStore_, IN const std::string& strConfigPath_)
