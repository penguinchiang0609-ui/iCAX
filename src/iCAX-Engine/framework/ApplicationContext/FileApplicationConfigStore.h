    ...
    namespace Application
    {
        ...
        */
        ...
        public:
            ...
            */
            iCAX::Data::PropertyBag Load(IN const std::string& strPath_) const override;
            ...
            */
            void Save(IN const std::string& strPath_, IN const iCAX::Data::PropertyBag& Settings_) const override;
        };
    }
}
