    ...
    namespace Database
    {
        ...
        */
        ...
        public:
            ...
            */
            [[nodiscard]] virtual bool AddComponent(IN const std::string& strClassName_, OUT std::shared_ptr<CComponentBase>& pComponent_, OUT std::string& strError_) override;
            ...
            */
            [[nodiscard]] virtual bool RemoveComponent(IN const std::string& strClassName_, OUT std::string& strError_) override;
