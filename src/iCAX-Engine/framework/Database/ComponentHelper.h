...
public: \
    ...
    [[nodiscard]] bool Set##name(const type& value, std::string& strError_) \
    { \
        return SetProperty(#name, (toVariantLambda)(value), strError_); \
    } \
    [[nodiscard]] bool Set##name(const type& value) \
    { \
        std::string _strError; \
        return Set##name(value, _strError); \
    } \
private: \
            ...
            { \
                registry.RegistPropertyByName(ownerType::S_ClassName, #name, \
                    ...
                    { \
                        ...
                        p->m_##name = fromVariantLambda(val);\
                    }, \
