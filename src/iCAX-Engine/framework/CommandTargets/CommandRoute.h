...
namespace iCAX
{
    namespace Command
    {
        ...
        */
        struct _COMMAND_TARGETS_EXP CCommandRoute final
        {
        ...
        * @brief 运行时计算命令名称码。
        */
        _COMMAND_TARGETS_EXP uint32_t CommandHash32(IN const std::string& strText_);
        ...
        */
        _COMMAND_TARGETS_EXP bool IsValidCommandName(IN const std::string& strName_);
        ...
        */
        _COMMAND_TARGETS_EXP bool IsValidCommandMainName(IN const std::string& strName_);

        /*
        * @brief 根据主/子命令名创建完整路由。
        */
        _COMMAND_TARGETS_EXP CCommandRoute MakeCommandRoute(
        ...
        */
        _COMMAND_TARGETS_EXP CCommandRoute MakeCommandRoute(IN uint64_t nRouteCode_);

        /*
        * @brief 格式化命令路由，优先输出名称，名称缺失时输出编码。
        */
        _COMMAND_TARGETS_EXP std::string FormatCommandRoute(IN const CCommandRoute& Route_);
    }
}
