...
{
    CDialogEx::DoDataExchange(pDX);
    DDX_Control(pDX, IDCANCEL, TESTIDLABEL);
    DDX_Control(pDX, IDC_EDIT1, txtTestID);
}
...
BEGIN_MESSAGE_MAP(CMFCSampleDlg, CDialogEx)
    ...
    ON_BN_CLICKED(IDCANCEL, &CMFCSampleDlg::OnBnClickedCancel)
    ON_BN_CLICKED(IDC_BUTTON1, &CMFCSampleDlg::OnBnClickedButton1)
    ON_BN_CLICKED(IDC_BUTTON2, &CMFCSampleDlg::OnBnClickedButton2)
    ON_BN_CLICKED(IDC_BUTTON3, &CMFCSampleDlg::OnBnClickedButton3)
END_MESSAGE_MAP()
...
void CMFCSampleDlg::OnBnClickedCancel()
{
...
{
    // TODO: 在此添加控件通知处理程序代码
    m_pMyDialog = new SceneDlg();
    m_pMyDialog->Create(IDD_DIALOG1, this);  // 非模态创建
