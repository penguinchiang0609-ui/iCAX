...
WPF Button
  ...
  -> IFrontendBridge.PostSDOFrame()
  -> ApplicationRuntime SDO
  -> backend command handler
  -> frontend SDO endpoint
  -> IFrontendBridge.PollSDOFrames()
  -> WPF DispatcherTimer
  -> CWpfMainWindow
```
...
- 右侧 SDO/payload 面板：显示后端响应和 payload。
